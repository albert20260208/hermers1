...
_HERMES_CORE_TOOLS = [
    ...
    "session_search",
    # RAG vector memory search
    "rag_search", "rag_add_memory", "rag_stats",
...
TOOLSETS = {
    ...
    "memory": {
        "description": "Persistent memory across sessions (personal notes + user profile) and RAG vector search",
